...
% Start Data @Earth for Nov 21, 2021
...
tau1 = 543*86400; %days*86400 sec SR
exitAng = 71*pi/180;
exitVec = 10250.*[cos(exitAng) sin(exitAng) 0];
JENTRY = exitVec;%q2
EV = StartVel;%q2
...
exitVec = -11050.*[cos(exitAng) sin(exitAng) 0];
JEXIT = exitVec;%q2
JV=JEncVel;%q2
...
JV;
%EV;
Vgain = (VscEX + jv) - (VscENT + jv);
disp(sprintf('Heliocentric velocity change at Jupiter is %s m/s', num2str(Vgain)));
